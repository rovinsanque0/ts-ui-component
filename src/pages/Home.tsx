...
<GradientHero>
  <HeroImage image="/images/rrc.jpg">
    ...
    >
      ...
      >
        Full-Stack Web Development Student • Backend-Focused • Python Lover
      </p>
      ...
      >
        I am a full-stack development student at Red River College Polytechnic.
        I enjoy backend logic, building practical systems, and writing clean,
        efficient code. Python is my favourite language.
      </p>
    </div>
  </HeroImage>
</GradientHero>
      ...
      <Section>
        ...
        <Grid>
          ...
          <Card title="Snipply">
            ...
            <Button onClick={() => window.open("https://github.com/rovinsanque0/Snipply")}>
              View Project
            </Button>
          </Card>
          ...
          <Card title="Pixelforge">
            ...
            <Button onClick={() => window.open("https://github.com/rovinsanque0/pixelforge")}>
              View Project
            </Button>
          </Card>
        </Grid>
        ...
        <Table>
          ...
          <tbody>
            <TableRow>
              ...
              <TableCell>
                Python, Java, HTML, SQL, JavaScript
              </TableCell>
            </TableRow>
            ...
            <TableRow>
              ...
              <TableCell>
                React/TypeScript, PHP, Ruby on Rails
              </TableCell>
            </TableRow>
            ...
            <TableRow>
              ...
              <TableCell>
                XAMPP, Flask, Git & GitHub, SSH, Docker, Husky,
                Kali Linux (basics), DVWA & security labs
              </TableCell>
            </TableRow>
          </tbody>
      ...
      <Section>
        ...
        <Grid>
          ...
          <Card title="Stack Overflow">
            ...
            <Button onClick={() => window.open("https://stackoverflow.com/questions")}>
              Visit
            </Button>
          </Card>
          ...
          <Card title="Programming With Mosh">
            ...
            <Button onClick={() => window.open("https://www.youtube.com/@programmingwithmosh")}>
              Visit
            </Button>
          </Card>
        </Grid>
      ...
      <Section>
        ...
        <Card title="Developer Setup">
          ...
          <p style={{ fontSize: "1rem", color: "#333" }}>
            ...
            <br />
            Extensions: ESLint, Prettier, VSCode Styled Components, Storybook, Jest
          </p>
          ...
          <p style={{ fontSize: "1rem", color: "#333" }}>Consolas, 'Courier New', monospace</p>
        </Card>
      </Section>
    </Page>
  );
