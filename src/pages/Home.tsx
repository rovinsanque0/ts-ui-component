    ...
    >
      ...
      <section>
        ...
        <div style={{ display: "flex", gap: "20px", flexWrap: "wrap" }}>
          ...
          <Card>
            ...
            <Text>
              Full store with authentication, cart, and admin dashboard.
            </Text>
            <Button onClick={() => window.open("https://github.com/yourrepo")}>
              View Project
            </Button>
          ...
          <Card>
            ...
            <Text>
              React frontend + PHP API backend content management system.
            </Text>
            <Button onClick={() => window.open("https://github.com/yourrepo")}>
              View Project
            </Button>
      ...
      <section>
        ...
        <div style={{ display: "flex", gap: "20px", flexWrap: "wrap" }}>
          ...
          <Card>
            ...
            <Button
              onClick={() => window.open("https://guides.rubyonrails.org")}
            >
              Visit
            </Button>
          </Card>
      ...
      <section>
        ...
        <Card>
          ...
          <Text>
            ESLint, Prettier, GitLens, Material Icon Theme, Tailwind
            IntelliSense
          </Text>
